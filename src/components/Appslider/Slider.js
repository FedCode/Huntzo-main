        ...
        <div className='slide-main' style={{ backgroundImage: `url(${sliderimg1})`}} >
          <div className='slider-item'>
            ...
            <Col span={8} xs={24} lg={8}>
              <div className='house-details'>
                  ...
                  <div className='house-body'>
                      ...
                      <Title level={4}>Landland Village</Title>
            ...
            <div className='content-card'>
               <Title level={2}>Find your dream home</Title>
               <Title level={4}>This is where you can find a dream home of your choice without stress</Title>
            </div>
            </Col>
          </Row>
            </div>
